...
class Zend_Scrypt
{
    ...
    */
    public static function scryptROMix($b, $n, $r)
    {
        $x = $b;
        $v = array();
        for ($i = 0; $i < $n; $i++) {
     ...
     */
    public static function scryptBlockMix($b, $r)
    {
        $x    = substr($b, -64);
        $even = '';
        $odd  = '';
     ...
     */
    public static function salsa208Core32($b)
    {
        $b32 = array();
        for ($i = 0; $i < 16; $i++) {
     ...
     * @see    https://tools.ietf.org/html/draft-josefsson-scrypt-kdf-01#section-4
     */
    public static function integerify($b)
    {
        $v = 'v';
        if (PHP_INT_SIZE === 8) {
            $v = 'V';
